...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final int count = getDisplayCount();
...
//                Log.d(TAG, "onDraw: outside");
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                if (!mIsDragging) {
                    ...
                    if ((ev.getX() < halfWidth - sixthWidth)) {
                        // last page
                        if (action != MotionEvent.ACTION_CANCEL) {
                            if (mCurrentPage > 0) {
                                ...
                                mCurrentPage = count;
                                mViewPager.setCurrentItem(mCurrentPage - 1, false);

                            }
                            return true;
                        }

                    } else if ((ev.getX() > halfWidth + sixthWidth)) {
                        // next page
                        if (action != MotionEvent.ACTION_CANCEL) {
    ...
    public void setCustomCount(int mCustomCount) {
        this.mCustomCount = mCustomCount;
    }
